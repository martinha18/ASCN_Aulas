...
# My VM
MY_VM_IP  = "192.168.57.10"   #Change me if needed!

# Control Plane VM
CONTROL_PLANE_IP  = "192.168.57.100"   #Change me if needed!

# Nodes VMs
Number_Nodes = 2 #number Node VMs to launch
NODES_IP_RANGE= "192.168.57" #Change me if needed!

# Monitor VM
MONITOR_VM_IP = "192.168.57.200" #Change me if needed!
